...
private MyNewsAdapter myNewsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Call<SearchResponse> call = client.getNews("skysports.com", "441e5fea5c6d4f29bee20f551a8cc836", 100);
        call.enqueue(new Callback<SearchResponse>() {
            ...
            public void onResponse(@NotNull Call<SearchResponse> call, @NotNull Response<SearchResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    myNewsAdapter = new MyNewsAdapter(SportsNews.this, articles);
                    mRecyclerview.setAdapter(myNewsAdapter);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(SportsNews.this);
