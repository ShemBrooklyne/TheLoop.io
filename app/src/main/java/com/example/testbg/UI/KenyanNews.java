...
public class KenyanNews extends AppCompatActivity {
        ...
        call.enqueue(new Callback<SearchResponse>() {
            ...
            public void onResponse(@NotNull Call<SearchResponse> call, @NotNull Response<SearchResponse> response) {
                if (response.isSuccessful()) {
                    ...
                    myNewsAdapter = new MyNewsAdapter(KenyanNews.this, articles);
                    mRecyclerview.setAdapter(myNewsAdapter);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(KenyanNews.this);
